...
{
    $this->db->query('INSERT INTO activity (name, date_reg_start, date_reg_end, activitystart, venue, `desc`, user_id, max_participants) VALUES (:name, :date_reg_start, :date_reg_end, :activitystart, :venue, :desc, :user_id, :max_participants)');
