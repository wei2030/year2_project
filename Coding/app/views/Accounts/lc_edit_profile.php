<div class="card shadow-sm">
    ...
    <div class="card-body border-top p-9">
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8">
                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('<?php echo URLROOT."/public/".$lecturerProfile->lc_image; ?>')">
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8">
                <textarea class="form-control form-control-solid" name="about_me" rows="3" required><?php echo $lecturerProfile->about_me ?></textarea>
            </div>
        </div>

        <!-- Submit Button -->
        <div class="card-footer d-flex justify-content-end py-6 px-9">
            <input type="hidden" id="update_lecturer" name="update_lecturer" value="update_lecturer">
