...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="https://media.licdn.com/dms/image/C4E0BAQF2uYlKl-qeWQ/company-logo_200_200/0/1622008554055?e=1707350400&v=beta&t=ljEkj7YeEBqF_4AKIpuJPg5OSeibHO_Vgj6ubG1Z2fw">
  ...
  <style>
    ...
    color: #FF0000; /* Adjust the color if you want a different color for error messages */
...
<body>
  ...
  <div class="container">
    <div class="login-box">
      <img src="https://www.youthventures.asia/content/images/2022/12/06D439C5-6E12-447F-87BB-77750DB927BE.png" class="logo" />
        ...
        <div class="table-container">
          <div class="table">
            ...
            <div class="user-box">
              ...
              <input class="input" type="text" id="fullName" name="fullName" placeholder="Enter your full name" required="required" />
            ...
            <div class="user-box">
              ...
              <input class="input" type="text" id="icNo" name="icNo" placeholder="Enter your IC number" required="required" />
              <span class="error-message"><?php echo $data['icNoError']; ?></span>
            </div>

            <div class="user-box">
            <label for="username">Username:</label>
        <input class="input" type="username" id="username" name="username" placeholder="Enter your username" required="required" />
        <span class="error-message"><?php echo $data['usernameError']; ?></span>
      </div>
      <br>
      <div class="user-box">
      <label for="password">Password:</label>
        <input class="input" type="password" id="password" name="password" placeholder="Enter your password" required="required" />
      ...
      <div>
          ...
          <div class="table">
            <div class="user-box">
              ...
              <input class="input" type="text" id="address"name="address" placeholder="Enter your city and state" required="required" />
            </div>

            <div class="user-box">
              <label for="university">University:</label>
              <input class="input" type="text" id="university" name="university" placeholder="Enter your university" required="required" />
            </div>
