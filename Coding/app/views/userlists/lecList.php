...
<h1 class="card-title ls-1" style="font-size: 24px; font-weight: bold; color: #fff;">List of Lecturers</h1>
    </div>
        ...
        <div class="table-responsive">
            <table id="kt_datatable_posts" class="table table-bordered gy-5 table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-size: 12px;"><?php echo $lec->lc_fullname; ?></td>
                        <td style="font-size: 12px;"><?php echo $lec->lc_email; ?></td>                     
                        <td style="font-size: 12px;"><?php echo $lec->lc_phone; ?></td>                     
                        <td style="font-size: 12px;"><?php echo $lec->lc_gender; ?></td>                     
                        <td style="font-size: 12px;"><?php echo $lec->lc_race; ?></td>                     
                        <td style="font-size: 12px;"><?php echo $lec->lc_address; ?></td>                     
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
