...
<h1 class="card-title ls-1" style="font-size: 24px; font-weight: bold; color: #fff;">List of Partners</h1>
    </div>
        ...
        <div class="table-responsive">
            <table id="kt_datatable_posts" class="table table-bordered gy-5 table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-size: 12px;" ><?php echo $org->pn_name; ?></td>
                        <td style="font-size: 12px;"><?php echo $org->pn_email; ?></td>                     
                        <td style="font-size: 12px;"><?php echo $org->pn_phone; ?></td>                  
                        <td style="font-size: 12px;"><?php echo $org->pn_address; ?></td>                     
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
