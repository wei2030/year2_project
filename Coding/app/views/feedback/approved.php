...
<h1 class="card-title" style="font-size: 24px; font-weight: bold; color: #fff;">Feedback Approved</h1>
        ...
        <div class="table-responsive">
            <table id="kt_datatable_posts" class="table table-hover table-bordered gy-5">
                ...
                <tr class="fw-bold text-white" style="background: linear-gradient(to right, #183D64, #7C1C2B);">
                        ...
                        <th class="w-50px"style="color: #FFFFFF; font-size: 14px;">Status</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $index = 1 ?>
...
<?php if ($activities->projectFile != null) {
            ...
            echo 'No evidence';
                ...
                <?php if ($_SESSION['user_role'] == "Lecturer"): ?>
                    <div class="modal fade" tabindex="-1" id="kt<?php echo $feedback2->feedback_id?>">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-footer">
                                <form action="<?php echo URLROOT . "/feedback/delete/" . $feedback2->feedback_id; ?>" method="POST">
